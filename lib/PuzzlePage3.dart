...
/// from [ThemeBloc].
/// {@endtemplate}
class PuzzlePage3 extends StatelessWidget {
  /// {@macro puzzle_page}
  const PuzzlePage3({Key? key}) : super(key: key);
...
/// Displays the content for the [PuzzlePage3].
/// {@endtemplate}
...
class _PuzzleSectionsRotatingState extends State<PuzzleSectionsRotating>  with TickerProviderStateMixin{
  late final AnimationController _controller = AnimationController(
    duration: const Duration(minutes: 2), //3
    vsync: this,
  )..repeat();

  int _currentSliderValue = -33;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      //TODO add rotating feature for medium and large
